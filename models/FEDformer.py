...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.version = configs.version  # Wavelets, Fourier
        self.mode_select = configs.mode_select  # how to select modes
        self.modes = configs.modes  # num of selected modes
        self.seq_len = configs.seq_len
        self.label_len = configs.label_len
        self.pred_len = configs.pred_len
        self.output_attention = configs.output_attention

        # Moving averages(s) time series decompostion module
        ...
        # create constituing parts for encoder and decoder
        ...
        # Encoder
        # trim num of modes to seq_len // 2
        ...
        self.encoder = Encoder(
            # layers list: EncoderLayer(AutoCorrelationLayers(), params)
            [
                EncoderLayer(
        ...
        self.decoder = Decoder(
            ...
            #   AutoCorrelationLayer(self-attention),
            #   AutoCorrelationLayer(cross-attention), params)
            [
                DecoderLayer(
                    AutoCorrelationLayer(
